...
namespace Juego_v3
{
    class JuegoPPTLS : ILogica
    {
        ...
        public int comprobar(string jugada1, string jugada2)
        {
            ...
            if ((pos1 + 1) % this.jugadas.Length == pos2 || (pos1 + 3) % this.jugadas.Length == pos2) return 2;
            if ((pos2 + 1) % this.jugadas.Length == pos1 || (pos2 + 3) % this.jugadas.Length == pos1) return 1;
